...
from hidden_vllm.compilation.levels import CompilationLevel
...
from hidden_vllm.model_executor.models.interfaces import supports_lora
from hidden_vllm.multimodal import MULTIMODAL_REGISTRY, MultiModalRegistry
from hidden_vllm.prompt_adapter.worker_manager import LRUCacheWorkerPromptAdapterManager
from hidden_vllm.utils import DeviceMemoryProfiler, is_hip, supports_dynamo
...
class ModelRunner(ModelRunner):
    ...
    def load_model(self) -> None:
        ...
        if envs.VLLM_TORCH_COMPILE_LEVEL == CompilationLevel.DYNAMO_AS_IS and supports_dynamo():
            from hidden_vllm.plugins import get_torch_compile_backend
