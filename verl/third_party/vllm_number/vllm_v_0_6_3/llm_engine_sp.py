...
from hidden_vllm.config import (
    CacheConfig,
    DecodingConfig,
    DeviceConfig,
    EngineConfig,
...
from hidden_vllm.core.scheduler import Scheduler
from hidden_vllm.engine.arg_utils import EngineArgs
from hidden_vllm.engine.llm_engine import LLMEngine, SchedulerContext, SchedulerOutputState, _load_generation_config_dict
from hidden_vllm.engine.metrics_types import StatLoggerBase
from hidden_vllm.engine.output_processor.interfaces import SequenceGroupOutputProcessor
from hidden_vllm.engine.output_processor.stop_checker import StopChecker
from hidden_vllm.executor.executor_base import ExecutorBase
from hidden_vllm.inputs import INPUT_REGISTRY, InputRegistry
from hidden_vllm.inputs.preprocess import InputPreprocessor
from hidden_vllm.logger import init_logger
from hidden_vllm.sequence import Sequence
from hidden_vllm.tracing import init_tracer
from hidden_vllm.transformers_utils.detokenizer import Detokenizer
from hidden_vllm.transformers_utils.tokenizer import AnyTokenizer
from hidden_vllm.usage.usage_lib import UsageContext, is_usage_stats_enabled, usage_message
from hidden_vllm.utils import Counter, weak_bind
from hidden_vllm.version import __version__ as VLLM_VERSION
...
class LLMEngine(LLMEngine):
    ...
    def __init__(
        ...
        if is_usage_stats_enabled():
            from hidden_vllm.model_executor.model_loader import get_architecture_class_name
        ...
        if self.log_stats:
            if stat_loggers is not None:
                ...
                from hidden_vllm.engine.metrics import LoggingStatLogger, PrometheusStatLogger
