...
from hidden_vllm.model_executor.layers.vocab_parallel_embedding import VocabParallelEmbedding, ParallelLMHead
from hidden_vllm.model_executor.layers.activation import ScaledActivation
