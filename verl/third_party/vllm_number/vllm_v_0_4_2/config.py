...
from hidden_vllm import get_quantization_config
from hidden_vllm import get_hf_text_config
from hidden_vllm import is_hip
# Add for verl
from hidden_vllm import ModelConfig, _get_and_verify_dtype, _get_and_verify_max_len
