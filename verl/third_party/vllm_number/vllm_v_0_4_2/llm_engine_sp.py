...
import hidden_vllm
from hidden_vllm import (CacheConfig, DecodingConfig, DeviceConfig, LoRAConfig, ParallelConfig, SchedulerConfig,
                         SpeculativeConfig, VisionLanguageConfig)
from hidden_vllm import Scheduler
from hidden_vllm import (SequenceGroupOutputProcessor)
from hidden_vllm import StopChecker
from hidden_vllm import ExecutorBase
from hidden_vllm import init_logger
from hidden_vllm import Detokenizer
from hidden_vllm import StatLogger
from hidden_vllm import (UsageContext, is_usage_stats_enabled, usage_message)
from hidden_vllm import Counter
from hidden_vllm import _load_generation_config_dict
from hidden_vllm import LLMEngine
...
class LLMEngine(LLMEngine):
    ...
    def __init__(
        ...
        if is_usage_stats_enabled():
            from hidden_vllm import (get_architecture_class_name)
