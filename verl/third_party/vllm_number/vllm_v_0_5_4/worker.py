...
from hidden_vllm.model_executor import set_random_seed
from hidden_vllm.sequence import (ExecuteModelRequest, IntermediateTensors, SamplerOutput)
from hidden_vllm.worker.cache_engine import CacheEngine
# TODO(sgm): check why vllm has similar file in vllm.model_executor.parallel_utils.parallel_state
from hidden_vllm.distributed import (init_distributed_environment, set_custom_all_reduce, get_tensor_model_parallel_group)
from hidden_vllm.worker.worker_base import WorkerInput
from hidden_vllm.worker.worker import Worker, _check_if_gpu_supports_dtype
from hidden_vllm.worker.model_runner_base import ModelRunnerBase, ModelRunnerInputBase
from hidden_vllm.worker.embedding_model_runner import EmbeddingModelRunner
...
class Worker(Worker):
    ...
    def __init__(
        ...
        if self.model_config.trust_remote_code:
            ...
            from hidden_vllm.utils import init_cached_hf_modules
