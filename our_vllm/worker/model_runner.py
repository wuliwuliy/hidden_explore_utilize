...
from our_vllm.attention import AttentionMetadata, get_attn_backend
from our_vllm.config import (CacheConfig, DeviceConfig, LoadConfig, LoRAConfig,
                         ModelConfig, MultiModalConfig, ParallelConfig,
                         PromptAdapterConfig, SchedulerConfig)
from our_vllm.distributed import get_pp_group
from our_vllm.distributed.parallel_state import graph_capture
from our_vllm.inputs import INPUT_REGISTRY
from our_vllm.logger import init_logger
from our_vllm.lora.layers import LoRAMapping
from our_vllm.lora.request import LoRARequest
from our_vllm.lora.worker_manager import LRUCacheWorkerLoRAManager
from our_vllm.model_executor import SamplingMetadata
from our_vllm.model_executor.model_loader import get_model
from our_vllm.model_executor.model_loader.tensorizer import TensorizerConfig
from our_vllm.model_executor.models.interfaces import (supports_lora,
                                                   supports_vision)
from our_vllm.model_executor.models.utils import set_cpu_offload_max_bytes
from our_vllm.multimodal import (MULTIMODAL_REGISTRY, BatchedTensorInputs,
                             MultiModalInputs)
from our_vllm.prompt_adapter.layers import PromptAdapterMapping
from our_vllm.prompt_adapter.request import PromptAdapterRequest
from our_vllm.prompt_adapter.worker_manager import (
    LRUCacheWorkerPromptAdapterManager)
from our_vllm.sampling_params import SamplingParams
from our_vllm.sequence import (IntermediateTensors, SamplerOutput,
                           SequenceGroupMetadata)
from our_vllm.utils import (CudaMemoryProfiler, flatten_2d_lists,
                        get_kv_cache_torch_dtype, is_hip,
                        is_pin_memory_available)
from our_vllm.worker.model_runner_base import (
...
class GPUModelRunnerBase(ModelRunnerBase[TModelInputForGPU]):
    ...
    def save_sharded_state(
        ...
        from our_vllm.model_executor.model_loader.loader import ShardedStateLoader
    ...
    def save_tensorized_model(
        ...
        from our_vllm.model_executor.model_loader.loader import TensorizerLoader
    ...
    def execute_model(
        ...
        if self.return_hidden_states:
            ...
            if model_input.is_prompt:
                ...
                # 1. 使用 hidden_or_intermediate_states 来造（过了RMSNorm）
                # prompt_lens = []
                # last_indexz = -1
                # for index_val in indices:
                #     current_index = index_val.item()
                #     prompt_lens.append(current_index - last_indexz)
                #     last_indexz = current_index
                # all_tokens_hidden_states_list = list(torch.split(hidden_or_intermediate_states, prompt_lens, dim=0))
                # if not hasattr(output, 'hidden_states_prefill'):
                #     output.hidden_states_prefill = all_tokens_hidden_states_list
                ...
                if all_hidden_states_from_model:
                    ...
                    all_prompts_tensor = torch.stack(prompt_tensors, dim=0)
