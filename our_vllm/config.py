...
from our_vllm.model_executor.layers.quantization import QUANTIZATION_METHODS
from our_vllm.model_executor.models import ModelRegistry
from our_vllm.tracing import is_otel_installed
from our_vllm.transformers_utils.config import get_config, get_hf_text_config
from our_vllm.utils import (cuda_device_count_stateless, get_cpu_memory, is_cpu,
...
if TYPE_CHECKING:
    ...
    from our_vllm.model_executor.model_loader.loader import BaseModelLoader
    from our_vllm.transformers_utils.tokenizer_group.base_tokenizer_group import (
        BaseTokenizerGroup)
...
class ModelConfig:
    ...
    def get_num_layers(self, parallel_config: "ParallelConfig") -> int:
        from our_vllm.distributed.utils import get_pp_indices
