...
from our_vllm.model_executor.custom_op import CustomOp
...
class UnquantizedFusedMoEMethod(FusedMoEMethodBase, CustomOp):
    ...
    def forward_cuda(
        ...
        from our_vllm.model_executor.layers.fused_moe.fused_moe import fused_moe
        return fused_moe(x,
                         w1,
                         w2,
                         router_logits,
    ...
    def forward_tpu(
        ...
        from our_vllm.model_executor.layers.fused_moe.moe_pallas import fused_moe
