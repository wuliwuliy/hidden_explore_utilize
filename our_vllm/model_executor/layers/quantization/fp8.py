...
from our_vllm import _custom_ops as ops
from our_vllm.logger import init_logger
from our_vllm.model_executor.layers.fused_moe import FusedMoE, FusedMoEMethodBase
from our_vllm.model_executor.layers.linear import (LinearBase, LinearMethodBase,
                                               UnquantizedLinearMethod)
from our_vllm.model_executor.layers.quantization.base_config import (
    QuantizationConfig, QuantizeMethodBase)
from our_vllm.model_executor.layers.quantization.kv_cache import BaseKVCacheMethod
from our_vllm.model_executor.layers.quantization.utils.marlin_utils_fp8 import (
    apply_fp8_marlin_linear, prepare_fp8_layer_for_marlin)
from our_vllm.model_executor.layers.quantization.utils.quant_utils import (
    is_layer_skipped)
from our_vllm.model_executor.layers.quantization.utils.w8a8_utils import (
    all_close_1d, apply_fp8_linear, convert_to_channelwise,
    create_per_tensor_scale_param, cutlass_fp8_supported,
    per_tensor_dequantize, requantize_with_max_scale)
from our_vllm.model_executor.utils import set_weight_attrs
from our_vllm.platforms import current_platform
...
class Fp8Config(QuantizationConfig):
    ...
    def get_quant_method(self, layer: torch.nn.Module,
        ...
        from our_vllm.attention.layer import Attention  # Avoid circular import
