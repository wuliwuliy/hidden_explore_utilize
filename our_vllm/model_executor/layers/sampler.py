...
if HAS_TRITON:
    from our_vllm.model_executor.layers.ops.sample import sample as sample_triton

from our_vllm.model_executor.sampling_metadata import (SamplingMetadata,
                                                   SamplingTensors,
                                                   SequenceGroupToSample)
from our_vllm.sampling_params import SamplingType
from our_vllm.sequence import (CompletionSequenceGroupOutput, Logprob,
