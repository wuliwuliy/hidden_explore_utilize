...
from our_vllm.entrypoints.openai.protocol import (
    ...
    CompletionRequest)
from our_vllm.model_executor.guided_decoding.guided_fields import (
    GuidedDecodingRequest)
from our_vllm.model_executor.guided_decoding.outlines_decoding import (
    get_local_outlines_guided_decoding_logits_processor,
    get_outlines_guided_decoding_logits_processor)
from our_vllm.sampling_params import LogitsProcessor
...
async def get_guided_decoding_logits_processor(
    ...
    if guided_decoding_backend == 'lm-format-enforcer':
        from our_vllm.model_executor.guided_decoding.lm_format_enforcer_decoding import (  # noqa
