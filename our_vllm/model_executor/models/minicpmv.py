...
from our_vllm.attention import AttentionMetadata
from our_vllm.config import CacheConfig, MultiModalConfig
from our_vllm.inputs import INPUT_REGISTRY, InputContext, LLMInputs
from our_vllm.logger import init_logger
from our_vllm.model_executor.layers.linear import ReplicatedLinear
from our_vllm.model_executor.layers.logits_processor import LogitsProcessor
from our_vllm.model_executor.layers.quantization.base_config import (
    QuantizationConfig)
from our_vllm.model_executor.layers.sampler import Sampler
from our_vllm.model_executor.layers.vocab_parallel_embedding import ParallelLMHead
from our_vllm.model_executor.model_loader.utils import set_default_torch_dtype
from our_vllm.model_executor.model_loader.weight_utils import default_weight_loader
from our_vllm.model_executor.models.interfaces import SupportsVision
from our_vllm.model_executor.models.llama import LlamaModel
from our_vllm.model_executor.models.minicpm import MiniCPMModel
from our_vllm.model_executor.models.qwen2 import Qwen2Model
from our_vllm.model_executor.sampling_metadata import SamplingMetadata
from our_vllm.multimodal import MULTIMODAL_REGISTRY
from our_vllm.multimodal.image import (cached_get_image_processor,
                                   cached_get_tokenizer)
from our_vllm.sequence import IntermediateTensors, SamplerOutput, SequenceData
...
class MiniCPMVQwen2(MiniCPMVBaseModel):
    ...
    def init_vision_module(self) -> nn.Module:
        ...
        from our_vllm.model_executor.models.na_vit import SiglipVisionTransformer
