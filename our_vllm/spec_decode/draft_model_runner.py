...
try:
    from our_vllm.attention.backends.flash_attn import FlashAttentionMetadata
except ModuleNotFoundError:
    # vllm_flash_attn is not installed, use the identical ROCm FA metadata
    from our_vllm.attention.backends.rocm_flash_attn import (
...
from our_vllm.multimodal import MultiModalInputs
from our_vllm.sequence import (ExecuteModelRequest, IntermediateTensors,
                           SamplerOutput)
from our_vllm.worker.model_runner import (ModelInputForGPUWithSamplingMetadata,
                                      ModelRunner)
