...
from our_vllm.distributed.device_communicators.cuda_wrapper import CudaRTLibrary
from our_vllm.logger import init_logger
from our_vllm.utils import (cuda_device_count_stateless,
...
def gpu_p2p_access_check(src: int, tgt: int) -> bool:
    ...
    from our_vllm.distributed.parallel_state import get_world_group
