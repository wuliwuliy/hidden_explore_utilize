...
class GroupCoordinator:
    ...
    def __init__(
        ...
        from our_vllm.distributed.device_communicators.custom_all_reduce import (
            CustomAllreduce)
        from our_vllm.distributed.device_communicators.pynccl import (
            PyNcclCommunicator)
        ...
        from our_vllm.distributed.device_communicators.tpu_communicator import (
            TpuCommunicator)
        self.tpu_communicator: Optional[TpuCommunicator]
        if use_tpu_communicator and self.world_size > 1:
            self.tpu_communicator = TpuCommunicator(group=self.cpu_group)

        from our_vllm.distributed.device_communicators.shm_broadcast import (
            MessageQueue)
