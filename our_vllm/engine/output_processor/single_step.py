...
from our_vllm.config import SchedulerConfig
from our_vllm.core.scheduler import Scheduler
...
from our_vllm.sequence import (Sequence, SequenceGroup, SequenceGroupOutput,
...
class SingleStepOutputProcessor(SequenceGroupOutputProcessor):
    ...
    def process_prompt_logprob(self, seq_group: SequenceGroup,
        ...
        if hasattr(output, 'hidden_states_prefill'):
            ...
            if not hasattr(seq_group, 'hidden_states_prefill'):
