...
from our_vllm.triton_utils import HAS_TRITON

if HAS_TRITON:
    from our_vllm.lora.ops.bgmv_expand import bgmv_expand
    from our_vllm.lora.ops.bgmv_expand_slice import bgmv_expand_slice
    from our_vllm.lora.ops.bgmv_shrink import bgmv_shrink
    from our_vllm.lora.ops.sgmv_expand import sgmv_expand
    from our_vllm.lora.ops.sgmv_expand_slice import sgmv_expand_slice
    from our_vllm.lora.ops.sgmv_shrink import sgmv_shrink

if TYPE_CHECKING:
    # avoid circuit import
    from our_vllm.lora.layers import LoRAMapping
    from our_vllm.lora.models import LongContextLoRAContext
