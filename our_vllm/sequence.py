...
if TYPE_CHECKING:
    ...
    from our_vllm.spec_decode.metrics import SpecDecodeWorkerMetrics
...
class Sequence:
    ...
    def __init__(
        ...
        # 魔改
        self.hidden_states = torch.empty(0, device='cuda', dtype=torch.float32)  # 初始化为空张量
    ...
    def append_hidden_state(
        ...
        self.hidden_states = torch.cat([
            self.hidden_states, 
            hidden_states_tensor.unsqueeze(0)  # 添加批次维度 [1, num_layers, hidden_dim]
        ], dim=0)
